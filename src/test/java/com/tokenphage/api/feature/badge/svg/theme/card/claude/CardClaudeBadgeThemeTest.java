...
class CardClaudeBadgeThemeTest {
    ...
    class Layout {
        ...
        void reusesBaseLayout() {
            String svg = theme.build(dataWith(5_000_000L), BadgeMode.LIGHT);
            assertThat(svg)
        ...
        void mascotUsesCrispEdges() {
            ...
            String svg = theme.build(dataWith(50_000L), BadgeMode.LIGHT);
    ...
    class Levels {
        ...
        void lv2() {
            String svg = theme.build(dataWith(50_000_000L), BadgeMode.LIGHT);
        ...
        void lv3() {
            String svg = theme.build(dataWith(200_000_000L), BadgeMode.LIGHT);
        ...
        void lv4() {
            String svg = theme.build(dataWith(700_000_000L), BadgeMode.LIGHT);
        ...
        void lv5() {
            String svg = theme.build(dataWith(2_000_000_000L), BadgeMode.LIGHT);
    ...
    class FactsAndPop {
        ...
        void popUsesRecentDayTokens() {
            assertThat(theme.build(dataWith(700_000_000L), BadgeMode.LIGHT)).contains("+19.0K Tk");
        }
